 ...
 * @e_ident: A pointer pointing array with magic file
 *
 ...
 * @e_ident: A pointer pointing array with magic numbers
 *
 ...
 * @e_ident: pointer pointing array with magic number
 */
void print_class(unsigned char *e_ident)
{
	printf("  Class:                             ");
...
/**
 * print_data - a fucntion that prints the data of an ELF header.
 * @e_ident: a pointer
 */
void print_data(unsigned char *e_ident)
{
 ...
 * @e_ident: A pointer pointing the array with the ELF version.
 */
void print_osabi(unsigned char *e_ident)
{
	printf("  OS/ABI:                            ");
 ...
 * @e_entry: The address to the ELF entry point.
